...
The five isolated MySQL scenarios run through the CI workflow: hidden batch success, stale source rejection, replay protection, rollback after the second audit insert and simultaneous approval. Build and database evidence belongs to the GitHub run for the delivered commit.
