...
export function FieldSettingsPreview() {
  ...
  return <div className="container seller-page compact-fields"><div className="seller-page-head"><div><h1>إعدادات حقول الأقسام</h1><p>معاينة أدوات الإدارة — لا تتصل بقاعدة بيانات الموقع الحي.</p></div><Link className="button secondary" href="/classification/">تصنيف الإعلانات</Link><Link className="button secondary" href="/ads/new/">تجربة إضافة إعلان</Link></div><div className="seller-demo-note">يمكن لأي زائر تجربة هذه الصفحة. الإعدادات محلية له وحده، وليست لوحة إدارة فعلية أو صلاحيات على الموقع. إخفاء أو أرشفة حقل لا يحذف الإعلانات المحفوظة.</div><section className="seller-form-panel"><div className="seller-fields">
