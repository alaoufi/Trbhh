...
test('snapshot projection preserves original public content and never copies private columns',()=>{
  ...
  const row={id:7n,title:'عنوان أصلي',detail:'وصف أصلي',price:150,price_type:'rent',rent_period:'شهري',city:'الرياض',seller:'متجر',created_at:new Date('2026-09-19T00:00:00Z'),updated_at:new Date('2026-09-19T00:00:00Z'),adsType:'offer',category_id:8n,subcategory_id:9,trusted:1,phone:'SECRET',email:'SECRET',balance:77,password:'SECRET'};
  ...
  assert.equal(ad.priceType,'rent');assert.equal(ad.rentPeriod,'شهري');
