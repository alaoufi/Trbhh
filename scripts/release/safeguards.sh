...
if [[ "$release_profile" == onboarding_legacy_email ]]; then
...
if [[ "$phase" == after ]]; then
  ...
  if [[ "$release_profile" == onboarding_link || "$release_profile" == onboarding_template || "$release_profile" == onboarding_legacy_email ]]; then
