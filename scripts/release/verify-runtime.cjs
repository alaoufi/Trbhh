...
if(['merchant_oauth','merchant_headers','supplier_selection','public_home','national_day','national_day_immersive','national_day_loyalty','supplier_admin','banner_separation','onboarding_link'].includes(process.argv[4])){
