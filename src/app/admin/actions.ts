...
export async function saveSettingsAction(formData: FormData) {
  ...
  // نصوص المراسلة الجاهزة (تربح): مراسلة صاحب الإعلان + مراسلة الإدارة
