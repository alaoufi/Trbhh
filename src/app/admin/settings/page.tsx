  ...
  return (
    <div className="max-w-lg space-y-4">
      ...
      <form action={saveSettingsAction} className="space-y-2 rounded-xl border border-primary/20 bg-card p-4">
        ...
        <label className="block space-y-1">
          <span className="text-sm font-medium">الحد الأقصى لعدد الهويات الشخصية للعضو</span>
        ...
        <label className="block space-y-1">
          <span className="text-sm font-medium">الحد الأقصى لعدد المتاجر للعضو</span>
        ...
        <Group title="الميزات التفاعلية">
          <div className="space-y-2">
            ...
            <label className="flex items-start gap-2 text-sm">
              ...
              <span><b>جدولة النشر</b> — يحدد المعلن موعداً مستقبلياً ويُنشر إعلانه (العادي والمبوّب) تلقائياً وقتها. (لا تعمل مع وضع مراجعة الإعلانات).</span>
            </label>
            <label className="mr-6 flex flex-col gap-1 text-sm">
              <span>أقصى مدى للجدولة (بالأيام) — للإعلانات والمبوّبة</span>
              <input name="scheduleMaxDays" type="number" min={0} defaultValue={scheduleMaxDays} className="h-10 w-40 rounded-lg border border-primary/30 bg-white px-3 text-sm outline-none focus:ring-2 focus:ring-primary/40" />
              <span className="text-xs text-muted-foreground">كم يوماً مستقبلاً يُسمح بجدولة النشر خلاله. <b>0 = بلا حد</b>.</span>
            </label>
            <label className="flex items-start gap-2 text-sm">
            ...
            <label className="flex items-start gap-2 text-sm">
              <input type="checkbox" name="requestsMarketOn" defaultChecked={requestsMarketOn} className="mt-0.5 h-4 w-4 accent-primary" />
              <span><b>سوق الطلبات 🛒</b> — صفحة <code>/requests</code> تجمع كل إعلانات «طلب» (ما يبحث عنه العملاء) ليتصفّحها البائعون ويقدّموا عروضهم ويتواصلوا مباشرة مع الطالب. يظهر رابطها في القائمة. (مفعّل افتراضياً)</span>
            </label>
            <label className="flex items-start gap-2 text-sm">
              <input type="checkbox" name="adReviewsOn" defaultChecked={adReviewsOn} className="mt-0.5 h-4 w-4 accent-primary" />
              <span><b>تقييم الإعلانات ⭐</b> — يشارك العملاء تجربتهم مع كل إعلان وصاحبه عبر معايير متعدّدة (مطابقة الإعلان للواقع · مصداقية صاحبه · جودة المنتج · سهولة التواصل) مع رأي مكتوب وتوصية. يظهر ملخّص التقييم وتوزيع النجوم أسفل الإعلان — يعزّز الثقة والتنافس. (مفعّل افتراضياً)</span>
            </label>
            <label className="flex items-start gap-2 text-sm">
