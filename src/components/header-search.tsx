...
export function HeaderSearch() {
  ...
  return (
    <>
      <button type="button" onClick={() => setOpen(true)} aria-label="بحث" className="grid h-11 w-11 shrink-0 place-items-center rounded-full text-white transition hover:bg-white/10">
