...
import {
  ...
  Building2, Search, Shield, LogIn, LogOut, Share2, PlusCircle, Mail, HelpCircle, FileText, Phone, Sparkles, Crown, BookOpen, Wallet, Info, Store, Clapperboard, MapPin, Bell, Flame, Gavel, Palette, UserPen, ShieldCheck, Users, HandCoins, Scale,
} from 'lucide-react';
      ...
      <nav className="absolute inset-y-0 right-0 flex w-80 max-w-[85%] flex-col overflow-y-auto bg-card text-card-foreground shadow-2xl">
        ...
        {adminMode ? (
          ...
          <div className="flex-1 p-2">
            ...
            <Item href="/companies" icon={Store} onClick={close}>المكاتب العقارية</Item>
            <Item href="/requests" icon={HandCoins} onClick={close}>سوق الطلبات</Item>
            <Item href="/compare" icon={Scale} onClick={close}>مقارنة العقارات</Item>
            {isAuthed && (
