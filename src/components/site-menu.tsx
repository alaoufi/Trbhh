...
import {
  ...
  Building2, Search, Shield, LogIn, LogOut, Share2, PlusCircle,
} from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50" role="dialog" aria-modal="true">
          ...
          <nav className="absolute inset-y-0 right-0 flex w-80 max-w-[85%] flex-col overflow-y-auto bg-white shadow-2xl">
            ...
            <div className="flex-1 p-2">
              ...
              <Item href="/pages/faq" icon={MessagesSquare} onClick={close}>الأسئلة الشائعة</Item>
              <Item href="/pages/terms" icon={Shield} onClick={close}>الشروط والأحكام</Item>
