  ...
  return (
    <section id="paynow" className="card-3d order-first space-y-5 rounded-2xl border-2 border-emerald-400 bg-gradient-to-br from-emerald-50 via-white to-sky-50 p-5 shadow-lg shadow-emerald-900/10">
      <header className="flex items-start gap-3">
        ...
        <div className="min-w-0"><div className="mb-1 text-[11px] font-black tracking-wide text-emerald-700">الدفع الإلكتروني أولاً</div><h2 className="text-lg font-extrabold text-emerald-900">اشحن رصيدك فوراً وبأمان</h2><p className="mt-0.5 text-xs font-medium text-emerald-800">يُضاف الرصيد تلقائياً بعد تأكيد عملية الدفع.</p></div>
      </header>
      ...
      <form action={action} className="space-y-3">
        ...
        <ConfirmSubmit msg="الانتقال إلى صفحة الدفع الآمنة لإتمام شحن الرصيد؟" className="btn-3d flex h-14 w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 px-5 text-base font-extrabold text-white shadow-lg shadow-emerald-700/30"><LockKeyhole className="h-5 w-5" />الدفع الآمن الآن</ConfirmSubmit>
      </form>
