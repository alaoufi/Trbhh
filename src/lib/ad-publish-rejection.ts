...
const REJECTIONS: Record<AdPublishRejectionCode, AdPublishRejection> = {
  ...
  blocked: { title: 'رُفض الإعلان', reason: 'المحتوى يخالف سياسة النشر.', nextStep: 'احذف المحتوى المخالف. إن كان القرار غير صحيح تواصل مع الإدارة.' },
  ...
  banned: { title: 'النشر متوقف لحسابك', reason: 'تم إيقاف النشر بسبب مخالفات نشر متكررة.', nextStep: 'راجع سبب المخالفة، وللاعتراض أو طلب المراجعة تواصل مع الإدارة.' },
  editWindow: { title: 'تعذر حفظ التعديل', reason: 'انتهت المهلة المسموح بها لتعديل الإعلان.', nextStep: 'تواصل مع الإدارة إذا احتجت تعديلاً استثنائياً.' },
