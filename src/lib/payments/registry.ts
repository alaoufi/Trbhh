...
export const PROVIDER_META: ProviderMeta[] = [
  ...
  {
    id: 'alrajhi_arb',
    name: 'بوابة الراجحي الإلكترونية',
    ...
    creds: [
      ...
      { key: 'terminal_alias_name', label: 'Terminal Alias Name', secret: false },
      { key: 'tranportal_id', label: 'Tranportal ID', secret: false },
      { key: 'tranportal_password', label: 'Tranportal Password', secret: true },
      { key: 'terminal_resource_key', label: 'Terminal Resource Key', secret: true },
    ],
  },
  {
    id: 'neoleap',
    ...
    notes: 'قيد التجهيز — تسميات الحقول تطابق نموذج Neoleap/الراجحي حرفياً لتعبئتها بلا التباس. لا يُفعّل المحوّل قبل وثيقة Sandbox الرسمية وطريقة التوقيع.',
    creds: [
      { key: 'terminal_id', label: 'Terminal ID', secret: false },
      { key: 'terminal_name', label: 'Terminal Name', secret: false },
      { key: 'merchant_id', label: 'Merchant ID', secret: false },
