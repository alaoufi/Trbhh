...
/* بانر النصوص بين إعلانات الرئيسية: سطر لكل نص (تسويقي أو توعوي) — يظهر كل ~10 أسطر
   إعلانات بنص يتبدل عشوائياً. مسح كل النصوص من الإعدادات = إيقاف البانر. */
export const DEFAULT_FEED_BANNER_TEXTS = [
...
export async function getFeedBannerTexts(): Promise<string[]> {
  const raw = await getSetting('feed_banner_texts', DEFAULT_FEED_BANNER_TEXTS);
