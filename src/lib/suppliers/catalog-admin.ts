...
function eligible(row:Row):boolean{return row.connection_provider==='salla'&&row.profile_provider==='salla'&&row.connection_status==='connected'&&row.supplier_active===1&&row.maintenance===0;}
