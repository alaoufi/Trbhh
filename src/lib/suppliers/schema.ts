...
const TABLES:TableSpec[] = [
  ...
  },
  {
    ...
    columns: {
      ...
      oauth_scope_version: "INT NOT NULL DEFAULT 0",
  ...
  },
  {
    ...
    columns: {
      ...
      external_order_url: "VARCHAR(2048) NOT NULL DEFAULT ''",
  ...
  {
    name: "supplier_order_sync_attempts",
    columns: {
      id: "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT",
      supplier_order_id: "BIGINT UNSIGNED NOT NULL",
      attempt_no: "INT NOT NULL",
      operation: "VARCHAR(32) NOT NULL DEFAULT 'create_order'",
    ...
    primary: ["id"],
    unique: {"supplier_order_sync_attempt_once":["supplier_order_id","attempt_no"]},
    indexes: {"supplier_order_sync_jobs":["status","started_at","id"]},
    foreign: [
      {"name":"supplier_order_sync_attempt_fk","columns":["supplier_order_id"],"parent":"supplier_orders","refs":["id"]},
    ],
  },
  {
    name: "supplier_coordinator_notifications",
    columns: {
      id: "BIGINT UNSIGNED NOT NULL AUTO_INCREMENT",
      supplier_order_id: "BIGINT UNSIGNED NOT NULL",
      supplier_id: "BIGINT UNSIGNED NOT NULL",
      event: "VARCHAR(40) NOT NULL DEFAULT 'order_submitted'",
    ...
    primary: ["id"],
    unique: {"supplier_coordinator_notification_once":["supplier_order_id","event"]},
    indexes: {"supplier_coordinator_notification_jobs":["status","created_at","id"]},
    foreign: [
      {"name":"supplier_coordinator_notification_order_fk","columns":["supplier_order_id"],"parent":"supplier_orders","refs":["id"]},
      {"name":"supplier_coordinator_notification_supplier_fk","columns":["supplier_id"],"parent":"commerce_suppliers","refs":["id"]},
    ],
  },
  {
