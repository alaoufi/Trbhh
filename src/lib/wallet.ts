...
export type TxnReason = 'admin_credit' | 'admin_debit' | 'featured' | 'classified' | 'duplicate' | 'subscription' | 'refund' | 'topup' | 'bonus' | 'verify_gift' | 'store_show' | 'ad_show' | 'urgent' | 'bump' | 'points_convert' | 'referral' | 'welcome' | 'store_plus' | 'lead';
