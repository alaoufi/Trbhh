...
describe.skipIf(process.env.UPGRADE_DB_TESTS !== '1')('baseline to candidate upgrade preserves existing data', () => {
  ...
  beforeAll(async () => {
    ...
    await insert('ads', { id: 701, adsType: 'offer', user_id: 701, city_id: 701, category_id: 0, title: 'إعلان صناعي محفوظ', detail: 'بيانات اختبار محلية فقط', video_path: '/synthetic/video.mp4', adsSpecial: 'no', state: 'active', price: 123.45, profile_id: 701, created_at: created, updated_at: created });
