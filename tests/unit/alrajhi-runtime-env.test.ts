...
describe('Al Rajhi runtime environment', () => {
  it('passes every private Sandbox variable from the server env into the app container', () => {
    ...
    for (const key of ['ALRAJHI_ENVIRONMENT', 'ALRAJHI_TRANPORTAL_ID', 'ALRAJHI_TRANPORTAL_PASSWORD', 'ALRAJHI_TERMINAL_RESOURCE_KEY', 'ALRAJHI_PAYMENT_GATEWAY_URL', 'DATABASE_PAYMENT_SECRET']) {
