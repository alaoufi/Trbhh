...
describe('supplier admin inputs',()=>{
 ...
 it('never permits synchronization or automatic orders from a development profile',()=>{
  expect(()=>parseIntegrationControls(form({supplierId:'1',provider:'salla',mode:'development',syncEnabled:'1'}))).toThrow('supplier_invalid_fields');
