...
describe('supplier visual catalog backend',()=>{
 ...
 it('keeps development/demo source rows out of the selectable catalog query',async()=>{
  ...
  expect(catalogSql).toContain("ip.mode='live'");
 });
