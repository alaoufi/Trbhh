...
export const fixtureProducts: CjProductRow[] = [
  ...
  { ...base, id: 900017, name_ar: 'منتج اصطناعي لاختبار صور المعرض الطويلة والكميات', cj_product_id: 'fixture-pid', cj_sku: `FIXTURE-${'A'.repeat(240)}`, image: `${origin}/fixture-image/synthetic-front.svg`, images: JSON.stringify([`${origin}/fixture-image/synthetic-front.svg`, `${origin}/fixture-image/synthetic-back.svg`]), details_json: JSON.stringify({ variants: [{ vid:'fixture-vid',name:'Black-XL',optionKey:'Color-Black-Size-XL',sku:'TEST-ONLY',priceUsd:8,weight:100,attributes:{color:'Black',size:'XL'} }], variantCount: 1, weightMin: 100, weightMax: 100 }), sale_price_minor: 1001 },
