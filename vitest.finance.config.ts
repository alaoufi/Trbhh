...
export default defineConfig({
  ...
  test:{environment:'node',include:['tests/integration/finance-mysql.test.ts'],fileParallelism:false,maxWorkers:1,testTimeout:30000,hookTimeout:60000,env:{DATABASE_URL:databaseUrl,SUPPLIER_ALLOW_LIVE_ORDERS:'false'}},
});
